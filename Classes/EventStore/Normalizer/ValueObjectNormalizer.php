...
final class ValueObjectNormalizer implements DenormalizerInterface
{
    ...
    private function resolveConstructorMethod(string $dataType, string $className): ReflectionMethod
    {
        ...
        if ($namedConstructorMethod !== null) {
            ...
            $constructorMethod = (interface_exists('Neos\Flow\ObjectManagement\Proxy\ProxyInterface') && $reflectionClass->implementsInterface('Neos\Flow\ObjectManagement\Proxy\ProxyInterface')) ? $reflectionClass->getParentClass()->getConstructor() : $reflectionClass->getConstructor();
        }
